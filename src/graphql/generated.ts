...
export type ScheduledOperationAffectedDocument = Asset | Task;
...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask?: { __typename?: 'Task', id: string, stage: Stage } | null };
...
export type PublishTaskMutation = { __typename?: 'Mutation', publishTask?: { __typename?: 'Task', id: string } | null };
...
export type ToggleTaskDoneMutation = { __typename?: 'Mutation', updateTask?: { __typename?: 'Task', id: string, done: boolean } | null };

export type GetTasksQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTasksQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: string, title: string, done: boolean }> };


export const CreateTaskDocument = gql`
    mutation CreateTask($title: String!) {
  createTask(data: {title: $title, done: false}) {
    id
    stage
  }
}
...
export const PublishTaskDocument = gql`
  ...
  publishTask(where: {id: $id}, to: PUBLISHED) {
    ...
    `;
export type PublishTaskMutationFn = Apollo.MutationFunction<PublishTaskMutation, PublishTaskMutationVariables>;
 ...
 * });
 */
export function usePublishTaskMutation(baseOptions?: Apollo.MutationHookOptions<PublishTaskMutation, PublishTaskMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PublishTaskMutation, PublishTaskMutationVariables>(PublishTaskDocument, options);
      }
export type PublishTaskMutationHookResult = ReturnType<typeof usePublishTaskMutation>;
export type PublishTaskMutationResult = Apollo.MutationResult<PublishTaskMutation>;
export type PublishTaskMutationOptions = Apollo.BaseMutationOptions<PublishTaskMutation, PublishTaskMutationVariables>;
export const ToggleTaskDoneDocument = gql`
    mutation ToggleTaskDone($done: Boolean!, $id: ID!) {
  updateTask(data: {done: $done}, where: {id: $id}) {
    id
    done
  }
}
...
export const GetTasksDocument = gql`
    query GetTasks {
  tasks(orderBy: createdAt_DESC, stage: PUBLISHED) {
    id
    title
    done
  }
